...
def main(imshow=False):
    ...
    frame = cv2.imread("./data/floor_verification/unblocked.png")
    # fsc.annotate_floor_pixels(frame, "blocked_anno.png")
    ...
    # fsc.scale_calibration(rel_depth_map, True, "blocked_view.png")
